...
function middleware(request) {
    return __awaiter(this, void 0, void 0, function () {
        var supabaseResponse, supabase, user, isCliente, isTecnico, isAdmin, perfil;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    supabaseResponse = server_1.NextResponse.next({ request: request });
                    supabase = (0, ssr_1.createServerClient)(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
                        cookies: {
                            getAll: function () { return request.cookies.getAll(); },
                ...
                case 1:
                    ...
                    isCliente = request.nextUrl.pathname.startsWith('/cliente');
                    isTecnico = request.nextUrl.pathname.startsWith('/tecnico') &&
                    ...
                    if (!(isAdmin && user)) return [3 /*break*/, 3];
                ...
                case 2:
                    perfil = (_a.sent()).data;
                    if ((perfil === null || perfil === void 0 ? void 0 : perfil.tipo) !== 'admin') {
                        return [2 /*return*/, server_1.NextResponse.redirect(new URL('/login', request.url))];
                    }
                    _a.label = 3;
                case 3: return [2 /*return*/, supabaseResponse];
            }
        });
    });
}
